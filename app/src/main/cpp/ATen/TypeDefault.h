...
struct CAFFE2_API TypeDefault : public TypeExtendedInterface {
  ...
  std::tuple<Tensor &,Tensor &,Tensor &> svd_out(Tensor & res1, Tensor & res2, Tensor & res3, const Tensor & self, bool some, bool compute_uv) const override;
  ...
  Tensor to(const Tensor & self, Device device, bool non_blocking, bool copy) const override;
